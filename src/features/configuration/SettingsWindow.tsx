...
function SettingsWindow() {
  ...
  return (
    <Tabs defaultValue="audio-device" orientation="vertical" className="h-[100vh] px-2 py-4">
      <TabsList variant="line" className="mr-3">
      ...
      <TabsContent value="audio-device" className="px-4 py-4">
        
      </TabsContent>
      <TabsContent value="theme" className="flex flex-col gap-4 items-center px-2 py-4">
        <FormItem
      ...
      <TabsContent value="note-detection" className="flex flex-col gap-4 items-center px-2 py-4">
        <FormItem
          htmlFor="hop-size-ms"
          label="Hop Size"
      ...
      <TabsContent value="judgment" className="flex flex-col gap-4 items-center px-2 py-4">
        <FormItem
